...
from src.KDE_uncert.single_exp_AL_drift_new import single_experiment
...
def parse_args():
    ...
    parser.add_argument('--drift_detector', type=str, default=['DDM', 'ADWIN', 'HDDDM'],
                        choices=('None', 'DDM', 'EDDM', 'PH', 'ADWIN', 'HDDDM'))

    parser.add_argument('--dynamic_window', action='store_true', default=False)
    parser.add_argument('--dynamic_budget', action='store_true', default=False)
    ...
    parser.add_argument('--verification_latency', type=int, nargs='+', default=[0, 100, 200, 300, 400],
    ...
    parser.add_argument('--budget', type=float, nargs='+', default=[0.05, 0.1, 0.15, 0.2, 0.25, 0.4, 0.5, 0.75, 1.])
    ...
    parser.add_argument('--n_runs', type=int, default=5, help='Number or runs')
